...
const sizeMap: Record<number, string> = {
    ...
    3: "text-[1.15rem]/1 md:text-[1.4rem]/4 lg:text-[1.7rem]/6 2xl:text-[2.4rem]/6",
    4: "text-[1rem]/2 sm:text-[1.3rem]/2 md:text-[1.55rem]/4 lg:text-[1.8rem]/4 2xl:text-[2.4rem]/6"
} 
...
const utcSizeMap: Record<number, string> = {
    ...
    3: "text-[1rem] md:text-[1.15rem] lg:text-[1.5rem] 2xl:text-[1.9rem]",
    4: "text-[0.85rem] sm:text-[1rem] md:text-[1.3rem] lg:text-[1.7rem] 2xl:text-[1.8rem]"
}
    ...
    return (
        <div
            className={`
                ...
                w-full 
                ${locations.length === 4 || locations.length === 1 ?  "sm:w-auto sm:px-2 2xl:w-full 2xl:px-0 gap-1 2xl:gap-5"  : locations.length === 3 ? "gap-0 lg:gap-2 2xl:gap-4" : "gap-2 2xl:gap-5"}
                tracking-wide
            `}
        >
        <div className={`relative w-full ${locations.length === 4 ? "h-[1.4rem]" : locations.length === 3 ? "h-[1.4rem]" : "h-[2.4rem]"} flex justify-center items-center`}>
        {editing ? (
