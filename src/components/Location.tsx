...
const sizeMap: Record<number, string> = {
    1: "text-[1.8rem]/3 md:text-[2.2rem]/6 lg:text-[2.5rem]/6 xl:text-[2.7rem]/8 2xl:text-[2.9rem]/10",
    2: "text-[1.35rem]/2 md:text-[1.75rem]/4 lg:text-[1.9rem]/10 xl:text-[2rem]/8 2xl:text-[2.7rem]/8",
...
const utcSizeMap: Record<number, string> = {
    1: "text-[1.55rem] md:text-[1.9rem] lg:text-[2.1rem] 2xl:text-[2.2rem]",
